...
import { BRAND_INFO, FOOTER_LINKS } from '../constants.tsx';
    ...
    <footer className="bg-brand-surface border-t border-gray-700 text-brand-text-secondary">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="border-t border-gray-700 pt-8 text-center">
          <p className="text-sm">&copy; {new Date().getFullYear()} {BRAND_INFO.name}. All rights reserved.</p>
          <p className="text-xs mt-1">A Fictional Brand for Demonstration Purposes.</p>
        </div>
      </div>
    </footer>
  );
